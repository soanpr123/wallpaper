// import 'package:wallpaper/payments/upgrade.dart';
...
import 'package:wallpaper/ui/pages/home/wallpapers/homeScreen.dart' as home;
  ...
  Future<String> signInWithGoogle() async {
    ...
    if (user != null) {
      ...
      if (usersData[0] != null && usersData[1] != null) {
        ...
        print(doc.get("coverPhoto"));
        print(doc.get("following"));
        globals.prismUser = WallUsersV2.fromDocumentSnapshot(doc, user);
