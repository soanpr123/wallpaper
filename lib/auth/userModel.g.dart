...
class WallUsersV2Adapter extends TypeAdapter<WallUsersV2> {
  @override
  final int typeId = 15;

  @override
  WallUsersV2 read(BinaryReader reader) {
    ...
    return WallUsersV2(
      ...
      transactions: (fields[15] as List).cast<WallTransaction>(),
  ...
  @override
  void write(BinaryWriter writer, WallUsersV2 obj) {
    writer
      ..writeByte(18)
      ..writeByte(0)
      ..write(obj.username)
...
WallUsersV2 _$WallUsersV2FromJson(Map<String, dynamic> json) => WallUsersV2(
      ...
      transactions: (json['transactions'] as List<dynamic>)
          .map((e) => WallTransaction.fromJson(e as Map<String, dynamic>))
          .toList(),
      name: json['name'] as String,
      coverPhoto: json['coverPhoto'] as String?,
    );

Map<String, dynamic> _$WallUsersV2ToJson(WallUsersV2 instance) =>
    <String, dynamic>{
