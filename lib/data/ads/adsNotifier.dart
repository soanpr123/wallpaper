...
class AdsNotifier extends ChangeNotifier {
  ...
  Future<void> createRewardedAd() async {
    if (loadingAd == false && adLoaded == false) {
      ...
      await RewardedAd.load(
        adUnitId: kReleaseMode ? "ca-app-pub-3333742374217621/5057706476" : "ca-app-pub-3940256099942544/5224354917",
        request: request,
  ...
  void showRewardedAd(Function rewardFunc) {
    ...
    rewardedAd!.fullScreenContentCallback = FullScreenContentCallback(
      onAdShowedFullScreenContent: (RewardedAd ad) => logger.d('ad onAdShowedFullScreenContent.'),
