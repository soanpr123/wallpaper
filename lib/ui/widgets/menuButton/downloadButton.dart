...
class _DownloadDialogContentState extends State<DownloadDialogContent> {
  @override
  void initState() {
    final AdsNotifier adsNotifier = Provider.of<AdsNotifier>(context, listen: false);
          ...
          Row(
            ...
            children: <Widget>[
              ...
              TextButton(
                ...
                onPressed: () {
                  if (adsNotifier.loadingAd == false && adsNotifier.adLoaded == true) {
                ...
                child: Stack(
                  ...
                  children: <Widget>[
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 16.0,
                        color: adsNotifier.loadingAd == false && adsNotifier.adLoaded == true
                            ? Theme.of(context).accentColor
                            : Theme.of(context).accentColor.withOpacity(0.3),
                      ),
                    ),
                    adsNotifier.loadingAd == false && adsNotifier.adLoaded == true
                        ? Container()
