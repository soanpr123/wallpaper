...
import 'package:wallpaper/popup/noLoadLinkPopUp.dart';
...
import 'package:wallpaper/ui/pages/profile/aboutList.dart';
import 'package:wallpaper/ui/pages/profile/downloadList.dart';
import 'package:wallpaper/ui/pages/profile/drawerWidget.dart';
import 'package:wallpaper/ui/pages/profile/generalList.dart';
import 'package:wallpaper/ui/pages/profile/premiumList.dart';
import 'package:wallpaper/ui/pages/profile/userList.dart';
import 'package:wallpaper/ui/pages/profile/userProfileLoader.dart';
import 'package:wallpaper/ui/pages/profile/userProfileSetupLoader.dart';
                ...
                builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  if (snapshot.hasData && snapshot.data != null) {
                    ...
                    return ProfileChild(
                      ...
                      bio: snapshot.data!.docs[0].get("bio").toString(),
                      coverPhoto: snapshot.data!.docs[0].get("coverPhoto") as String,
                      email: snapshot.data!.docs[0].get("email").toString(),
                      links: snapshot.data!.docs[0].get("links") as Map,
                      name: snapshot.data!.docs[0].get("name").toString(),
                      premium: snapshot.data!.docs[0].get("premium") as bool,
                      userPhoto: snapshot.data!.docs[0].get("profilePhoto").toString(),
                      username: snapshot.data!.docs[0].get("username").toString(),
                      followers: snapshot.data!.docs[0].get("followers") as List,
                      following: snapshot.data!.docs[0].get("following") as List,
                    );
                  }
                  return Container(
                    color: Theme.of(context).primaryColor,
                                    ...
                                    if (widget.coverPhoto == null)
                                      ...
                                      CachedNetworkImage(
                                        imageUrl: widget.coverPhoto ??
                                            "https://images.pexels.com/photos/5421530/pexels-photo-5421530.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500",
                                        fit: BoxFit.cover,
                                        width: MediaQuery.of(context).size.width,
                                        height: MediaQuery.of(context).size.height * 0.19,
                                      ),
