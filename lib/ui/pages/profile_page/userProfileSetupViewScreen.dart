...
import 'package:wallpaper/data/informatics/dataManager.dart';
import 'package:wallpaper/data/profile/wallpaper/getUserProfile.dart' as user_data;
...
import 'package:wallpaper/ui/animated/showUp.dart';
import 'package:wallpaper/ui/pages/home/wallpapers/clockSetupOverlay.dart';

import 'package:wallpaper/ui/widgets/home/core/collapsedPanel.dart';

import 'package:wallpaper/ui/widgets/menuButton/downloadButton.dart';
import 'package:wallpaper/ui/widgets/menuButton/setWallpaperButton.dart';
                                    ...
                                    children: <Widget>[
                                      Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          GestureDetector(
                                            onTap: () async {
                                              // TODO: await createCopyrightLink(
                                              //     true, context,
                                  ...
                                  children: [
                                    SetupDetailsTile(
                                      ...
                                      tileText: Provider.of<user_data.UserProfileProvider>(context)
                                          ...
                                          : "${Provider.of<user_data.UserProfileProvider>(context).userProfileSetups![index!].get("wallpaper_url")[0]} - ${(Provider.of<user_data.UserProfileProvider>(context).userProfileSetups![index!].get("wallpaper_url") as List).length > 2 ? Provider.of<user_data.UserProfileProvider>(context).userProfileSetups![index!].get("wallpaper_url")[2].toString() : ""}",
                                      tileType: "Wallpaper",
                                      panelCollapsed: panelCollapsed,
...
class ModifiedDownloadButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Provider.of<user_data.UserProfileProvider>(context)
                ...
                .toString()[0] !=
            "["
        ? Provider.of<user_data.UserProfileProvider>(context).userProfileSetups![index!].get("wall_id") != null &&
                Provider.of<user_data.UserProfileProvider>(context).userProfileSetups![index!].get("wall_id") != ""
            ? DownloadButton(
                link: Provider.of<user_data.UserProfileProvider>(context)
                    .userProfileSetups![index!]
                    .get("wallpaper_url")
