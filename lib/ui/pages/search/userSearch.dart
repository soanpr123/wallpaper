...
class _UserSearchLoaderState extends State<UserSearchLoader> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<WallUsersV2>>(
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: ExpansionPanelList(
        ...
        children: widget.users.map<ExpansionPanel>((WallUsersV2 user) {
                                              ...
                                              onPressed: () {
                                                if (user.links != null) {
                                                  ...
                                                  if (links[e].toString().contains("@gmail.com")) {
                                                    launchUrl(Uri.parse("mailto:${user.links[e].toString()}"));
                                                  }
                                                } else {
                                                  launchUrl(Uri.parse(user.links[e].toString()));
                                                }
                                              }))
                                          .toList()
                                          .sublist(
